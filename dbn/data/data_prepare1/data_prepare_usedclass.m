load('feature_usedclass_home/home.mat');
...
fid = fopen('feature_usedclass_home/data_c17_train.txt','w');
...
fid = fopen('feature_usedclass_home/data_c17_valid.txt','w');
...
fid = fopen('feature_usedclass_home/data_c17_test.txt','w');
